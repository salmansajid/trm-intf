...
(function(){
    ...
    function user(Restangular, apiEndPoints, utilities){
        ...
        return {
            ...
            changeUserReadOnly: changeUserReadOnly
        ...
        function changeUserActive(userId, activeStatus){
            var obj = {
                'userId':userId,
                'activeStatus':activeStatus
            };
            return userAPI.customPOST(obj, apiEndPoints.userActiveStatus);
        }

        function changeUserReadOnly(userId, readOnlyStatus){
            var obj = {
                'userId':userId,
                'readOnlyStatus':readOnlyStatus
            };

            return userAPI.customPOST(obj, apiEndPoints.userReadOnlyStatus);
        }
